...
void ui_plotter() {
  ...
  lv_obj_t *chart1_label2 = lv_label_create(screen_plotter);
  lv_label_set_text(chart1_label2, "ml/s");
  ...
  lv_chart_set_range(chart2, LV_CHART_AXIS_PRIMARY_Y, 0, 750);
  ...
  lv_obj_t *chart2_label2 = lv_label_create(screen_plotter);
  lv_label_set_text(chart2_label2, "Mililiter");
  ...
  add_y_axis_extreme_labels(screen_plotter, chart2, 0, 750); // Chart2 dengan rentang 0-750
